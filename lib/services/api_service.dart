//Now let's make the HTTP request service
...
import 'package:star_lebanon/model/article_model.dart';
...
class ApiService {
  ...
  final endPointUrl =
      "http://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=c02ba310753e4ce898fcd87e5980ab1b";
  ...
  Future<List<Article>> getArticle() async {
    ...
    //first of all let's check that we got a 200 status code:
    //this means that the request was a success
